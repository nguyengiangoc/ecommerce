            ...
            <?php foreach($data['rows'] as $item) { ?>
                <tr id="row-<?php echo $item['id']; ?>">
                    <td>
                        ...
                        <input type="text" name="name-<?php echo $item['id']; ?>" id="name-<?php echo $item['id']; ?>" class="fld blurUpdateHideShow dn"
                        data-id="<?php echo $item['id']; ?>" value="<?php echo $item['name']; ?>" />
                        <div class="textSmall"><?php echo $item['post_codes']; ?></div>
                    </td>
                    <td class="ta_r">
                        <a href="/ecommerce/<?php echo $data['objURL']->getCurrent(
                        array('action', 'id'), false, array('action', 'codes', 'id', $item['id'])); ?>">Post code</a>
                    </td>
                    <td class="ta_r">
                        <a href="#" class="clickAddRowConfirm" data-url="/ecommerce/<?php echo $data['objURL']->getCurrent(
