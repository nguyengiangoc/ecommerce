        ...
        <tbody>
            <?php foreach($data['rows'] as $item) {?>
                <tr id="row-<?php echo $item['id']; ?>">
                    <td class="ta_r"><?php echo round($item['weight_from'], 2); ?></td>
                    <td class="ta_r"><?php echo round($item['weight'], 2); ?></td>
                    <td class="ta_r">&pound;<?php echo number_format($item['cost'], 2); ?></td>
                    <td class="ta_r">
                        <a href="#" class="clickAddRowConfirm" 
                    data-url="<?php echo '/ecommerce/'.$data['objURL']->getCurrent('call', false, array('call', 'remove', 'rid', $item['id'])); ?>"
