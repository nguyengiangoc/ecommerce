...
<?php if(!empty($rows)) { ?>
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
        ...
        <tr>
            ...
            <td class="ta_r"><a href="<?php echo $this->objURL->getCurrent('action').'/action/remove/id/'.$category['id']; ?>">Remove</a></td>
            <td class="ta_r"><a href="<?php echo $this->objURL->getCurrent('action').'/action/edit/id/'.$category['id']; ?>">Edit</a></td>
        </tr>
        <?php } ?>
    </table>
