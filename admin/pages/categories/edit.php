        ...
        if(!empty($category)) {
            ...
            if($objForm->isPost('name')) {
                ...
                if($objCatalogue->duplicateCategory($name, $id)) {
                    //kiem tra xem ngoai cai category co cai id dang update ra con cai nao khac co ten nhu vay khong
        ...
        <form action="" method="post">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
                <tr>
                    ...
                    <td><?php echo $objValid->validate('name'); echo $objValid->validate('name_duplicate'); ?><input type="text" name="name" id="name" value="<?php echo $objForm->stickyText('name', $category['name']); ?>" class="fld" /></td>
                </tr>
                <tr>
                    <th><label for="identity">Identity: *</label></th>
                    <td><?php echo $objValid->validate('identity'); $objValid->validate('duplicate_identity'); ?><input type="text" name="identity" id="identity" value="<?php echo $objForm->stickyText('identity', $category['identity']); ?>" class="fld" /></td>
                </tr>
                <tr>
                    <th><label for="meta_title">Meta title: *</label></th>
                    <td><?php echo $objValid->validate('meta_title'); ?><input type="text" name="meta_title" id="meta_title" value="<?php echo $objForm->stickyText('meta_title', $category['meta_title']); ?>" class="fld" /></td>
                </tr>
                <tr>
