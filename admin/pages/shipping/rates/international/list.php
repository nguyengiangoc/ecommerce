...
<form method="post" class="ajax" data-action="<?php echo BASE_PATH.'/'.$this->objURL->getCurrent('call', false, array('call', 'add')); ?>">
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
        ...
        <tr>
            <td>
                <input type="text" name="weight" id="weight" class="fld fldSmall" />
            </td>
            <td>
                <input type="text" name="cost" id="cost" class="fld fldSmall" />
            </td>
        </tr>
        <tr>
            <td colspan="2"><label for="btn_add" class="sbm sbm_blue fl_l"><input type="submit" id="btn_add" class="btn" value="Add" /></label></td>
        </tr>
    </table>
</form>
