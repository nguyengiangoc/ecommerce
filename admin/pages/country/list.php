...
?>
<h1>Countries</h1>
<form method="post" class="ajax" data-action="/ecommerce/<?php echo $this->objURL->getCurrent(array('action', 'id'), false, array('action', 'add')); ?>">
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
        ...
        <tr>
            <td>
                <input type="text" name="name" id="name" class="fld fldSmall" />
            </td>
        </tr>
        <tr>
            <td><label for="btn_add" class="sbm sbm_blue fl_l"><input type="submit" id="btn_add" class="btn" value="Add" /></label></td>
        </tr>
    </table>
</form>
