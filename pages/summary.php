<?php
    ...
    ?>
        ...
        <?php if(!empty($out)) { ?>
                ...
                <form action="" method="post" id="frm_basket br_bd">
                    <table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
                        ...
                        <tr class="rowHighLight">
                            ...
                            <td class="ta_r br_td"><i><?php echo $this->objCurrency->display(number_format($objBasket->sub_total, 2)); ?></i></td>
                        </tr>
                        <tr>
                        ...
                        <?php foreach($shipping as $srow) { ?>
                            <tr>
                                ...
                                <td class="ta_r"><?php echo $this->objCurrency->display(number_format($srow['cost'], 2)); ?></td>
                            </tr>
                        <?php } ?>
                        <tbody class="rowHighLight">
                            <tr>
                                <td colspan="2" class="br_td" >Sub-total:</td>
                                <td class="ta_r br_td" id="basketSubTotal"><?php echo $this->objCurrency->display(number_format($objBasket->final_sub_total, 2)); ?></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="br_td" >VAT (<?php echo $objBasket->vat_rate; ?>%)</td>
                                <td class="ta_r br_td" id="basketVAT"><?php echo $this->objCurrency->display(number_format($objBasket->final_vat, 2)); ?></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="br_td"><strong>Total:</strong></td>
                                <td class="ta_r br_td"><strong id="basketTotal"><?php echo $this->objCurrency->display(number_format($objBasket->final_total, 2)); ?></strong></td>
                            </tr>
                        </tbody>
                    </table>                
            ...
            <div class="dn"><img src="<?php echo BASE_PATH; ?>/images/loadinfo.net.gif" alt="Proceeding to PayPal" /></div>
